...
func (m *SkillMutation) SetSource(s skill.Source) {
	m.source = &s
}

// Source returns the value of the "source" field in the mutation.
func (m *SkillMutation) Source() (r skill.Source, exists bool) {
	v := m.source
	if v == nil {
		return
	}
...
// OldSource returns the old "source" field's value of the Skill entity.
// If the Skill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SkillMutation) OldSource(ctx context.Context) (v skill.Source, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SkillMutation) ResetSource() {
	m.source = nil
}

// SetTaskID sets the "task_id" field.
func (m *SkillMutation) SetTaskID(u uuid.UUID) {
	m.task_id = &u
}

// TaskID returns the value of the "task_id" field in the mutation.
func (m *SkillMutation) TaskID() (r uuid.UUID, exists bool) {
	v := m.task_id
	if v == nil {
		return
	}
...
// OldTaskID returns the old "task_id" field's value of the Skill entity.
// If the Skill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SkillMutation) OldTaskID(ctx context.Context) (v *uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SkillMutation) ClearTaskID() {
	m.task_id = nil
	m.clearedFields[skill.FieldTaskID] = struct{}{}
}

// TaskIDCleared returns if the "task_id" field was cleared in this mutation.
func (m *SkillMutation) TaskIDCleared() bool {
	_, ok := m.clearedFields[skill.FieldTaskID]
	return ok
}

// ResetTaskID resets all changes to the "task_id" field.
func (m *SkillMutation) ResetTaskID() {
	m.task_id = nil
	delete(m.clearedFields, skill.FieldTaskID)
}
...
// SetUserID sets the "user" edge to the User entity by id.
func (m *SkillMutation) SetUserID(id uuid.UUID) {
	m.user = &id
}
...
// UserID returns the "user" edge ID in the mutation.
func (m *SkillMutation) UserID() (id uuid.UUID, exists bool) {
	if m.user != nil {
		return *m.user, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UserID instead. It exists only for internal usage by the builders.
func (m *SkillMutation) UserIDs() (ids []uuid.UUID) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *SkillMutation) Fields() []string {
	...
	if m.source != nil {
		fields = append(fields, skill.FieldSource)
	}
	if m.task_id != nil {
		fields = append(fields, skill.FieldTaskID)
	}
	if m.created_at != nil {
...
func (m *SkillMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(skill.FieldTaskID) {
		fields = append(fields, skill.FieldTaskID)
	}
	return fields
}
...
func (m *UserMutation) SetAvatarPresetID(s string) {
	m.avatar_preset_id = &s
}

// AvatarPresetID returns the value of the "avatar_preset_id" field in the mutation.
func (m *UserMutation) AvatarPresetID() (r string, exists bool) {
	v := m.avatar_preset_id
	if v == nil {
		return
	}
	return *v, true
...
// OldAvatarPresetID returns the old "avatar_preset_id" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldAvatarPresetID(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAvatarPresetID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldAvatarPresetID requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldAvatarPresetID: %w", err)
	}
	return oldValue.AvatarPresetID, nil
}

// ClearAvatarPresetID clears the value of the "avatar_preset_id" field.
func (m *UserMutation) ClearAvatarPresetID() {
	m.avatar_preset_id = nil
	m.clearedFields[user.FieldAvatarPresetID] = struct{}{}
}

// AvatarPresetIDCleared returns if the "avatar_preset_id" field was cleared in this mutation.
func (m *UserMutation) AvatarPresetIDCleared() bool {
	_, ok := m.clearedFields[user.FieldAvatarPresetID]
	return ok
}

// ResetAvatarPresetID resets all changes to the "avatar_preset_id" field.
func (m *UserMutation) ResetAvatarPresetID() {
	m.avatar_preset_id = nil
	delete(m.clearedFields, user.FieldAvatarPresetID)
}
...
func (m *UserMutation) AddSkillIDs(ids ...uuid.UUID) {
	if m.skills == nil {
...
func (m *UserMutation) RemoveSkillIDs(ids ...uuid.UUID) {
...
func (m *UserMutation) RemovedSkillsIDs() (ids []uuid.UUID) {
...
func (m *UserMutation) SkillsIDs() (ids []uuid.UUID) {
...
func (m *UserMutation) Fields() []string {
	...
	if m.avatar_preset_id != nil {
		fields = append(fields, user.FieldAvatarPresetID)
	}
	if m.created_at != nil {
...
func (m *UserMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case user.FieldAvatarPresetID:
		return m.OldAvatarPresetID(ctx)
	case user.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case user.FieldUpdatedAt:
		return m.OldUpdatedAt(ctx)
...
func (m *UserMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(user.FieldAvatarPresetID) {
		fields = append(fields, user.FieldAvatarPresetID)
	}
	return fields
}
