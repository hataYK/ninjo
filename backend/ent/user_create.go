...
func (_c *UserCreate) AddPlanIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddPlanIDs(ids...)
	return _c
}

// AddPlans adds the "plans" edges to the Plan entity.
func (_c *UserCreate) AddPlans(v ...*Plan) *UserCreate {
...
func (_c *UserCreate) AddAvailabilityIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddAvailabilityIDs(ids...)
	return _c
}

// AddAvailabilities adds the "availabilities" edges to the Availability entity.
func (_c *UserCreate) AddAvailabilities(v ...*Availability) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
